...
public class Menu extends JPanel {
    ...
    public void setMenuFull(boolean menuFull) {
        ...
        if (menuFull) {
            ...
            footer.setHorizontalAlignment(getComponentOrientation().isLeftToRight() ? JLabel.LEFT : JLabel.RIGHT);
    ...
    private final String headerName = "PT DKA";
    private final String footerName = "App Inventory v1.0.0";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/inventory/icon/Dashboard.png")));
        header.putClientProperty(FlatClientProperties.STYLE, ""
                + "font:$Menu.header.font;"
                + "foreground:$Menu.foreground");
        footer = new JLabel(footerName);
        footer.putClientProperty(FlatClientProperties.STYLE, ""
                + "foreground:$Menu.foreground");
