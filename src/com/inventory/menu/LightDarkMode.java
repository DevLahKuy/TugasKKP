...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/inventory/menu/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/inventory/menu/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("com/inventory/menu/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("com/inventory/menu/light.svg"));
        }
    }
