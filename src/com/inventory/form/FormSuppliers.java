...
public class FormSuppliers extends javax.swing.JPanel {
    ...
    private final TableModelSuppliers tblModel = new TableModelSuppliers();
    private final ServiceSuppliers servis = new SuppliersDAO();
    ...
    private void searchData(){
        List<ModelSuppliers> list = servis.searchData(txtPencarian.getText());
        tblModel.setData(list);
    }

    private void addData() {
        FormInputSuppliers formInput = new FormInputSuppliers(null, true, 1, null, this);
    ...
    private void updateData() {
        ...
        if(row != -1){
            ModelSuppliers model = tblModel.getData(row);
            FormInputSuppliers formInput = new FormInputSuppliers(null, true, row, model, this);
            formInput.setVisible(true);
            loadData();
        }else{
