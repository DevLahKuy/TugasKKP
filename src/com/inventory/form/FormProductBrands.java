...
public class FormProductBrands extends javax.swing.JPanel {

    private final TableModelProductBrands tblModel = new TableModelProductBrands();
    private final ServiceProductBrands servis = new ProductBrandsDAO();
    
    public FormProductBrands() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA MASTER > Merk");
    ...
    private void searchData(){
        List<ModelProductBrands> list = servis.searchData(txtPencarian.getText());
        tblModel.setData(list);
    }

    private void addData() {
        FormInputProductBrands formInput = new FormInputProductBrands(null, true, 1, null, this);
    ...
    private void updateData() {
        ...
        if(row != -1){
            ModelProductBrands brand = tblModel.getData(row);
            FormInputProductBrands formInput = new FormInputProductBrands(null, true, row, brand, this);
            formInput.setVisible(true);
            loadData();
        }else{
