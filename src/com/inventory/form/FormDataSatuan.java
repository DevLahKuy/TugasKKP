...
public class FormDataSatuan extends javax.swing.JDialog {
    ...
    public FormDataSatuan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataSatuan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDataSatuan dialog = new FormDataSatuan(new javax.swing.JFrame(), true);
    ...
    private void selectedData(){
        ...
        unit.setIdSatuan(tblData.getModel().getValueAt(row, 0).toString());
        unit.setNamaSatuan(tblData.getModel().getValueAt(row, 1).toString());
        dispose();
    }

    private void pencarianData() {
        List<ModelSatuan> list = servis.pencarianData(t_search.getText());
        tblModel.setData(list);
    }
