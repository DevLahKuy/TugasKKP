...
public class FormDataJenisBarang extends javax.swing.JDialog {
    ...
    public ModelJenisBarang jenisbarang = new ModelJenisBarang();
    ...
    public FormDataJenisBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataJenisBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDataJenisBarang dialog = new FormDataJenisBarang(new javax.swing.JFrame(), true);
    ...
    private void selectedData(){
        ...
        jenisbarang.setIdJenisBarang(tblData.getModel().getValueAt(row, 0).toString());
        jenisbarang.setNamaJenisBarang(tblData.getModel().getValueAt(row, 1).toString());
        dispose();
    }

    private void pencarianData() {
        List<ModelJenisBarang> list = servis.pencarianData(pencarian.getText());
        tblModel.setData(list);
    }
