...
public class FormDataModelType extends javax.swing.JDialog {
    ...
    public FormDataModelType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataModelType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDataModelType dialog = new FormDataModelType(new javax.swing.JFrame(), true);
    ...
    private void selectedData(){
        ...
        model.setIdModelTypeItems(tblData.getModel().getValueAt(row, 0).toString());
        model.setNameTypeItems(tblData.getModel().getValueAt(row, 1).toString());
        dispose();
    }

    private void searchData() {
        List<ModelTypeItems> list = servis.searchData(t_Search.getText());
        tblModel.setData(list);
    }
