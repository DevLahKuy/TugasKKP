...
import com.inventory.tablemodel.TableModelUsers;
...
public class FormUsers extends javax.swing.JPanel {
    ...
    private final TableModelUsers tblModel = new TableModelUsers();
    private final ServiceUsers servis = new UsersDAO();
    ...
    private void loadData() {
        List<ModelUsers> list = servis.viewData();
        tblModel.setData(list);
    }
    
    private void searchData(){
        List<ModelUsers> list = servis.searchData(txtPencarian.getText());
        tblModel.setData(list);
    }

    private void addData() {
        FormInputUsers formInput = new FormInputUsers(null, true, 1, null, this);
    ...
    private void updateData() {
        ...
        if(row != -1){
            ModelUsers user = tblModel.getData(row);
            FormInputUsers formInput = new FormInputUsers(null, true, row, user, this);
            formInput.setVisible(true);
            loadData();
        }else{
