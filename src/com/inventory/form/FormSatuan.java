...
public class FormSatuan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA MASTER > Satuan");
    ...
    private void pencarianData(){
        List<ModelSatuan> list = servis.pencarianData(txtPencarian.getText());
        tblModel.setData(list);
    }

    private void tambahData() {
        FormInputSatuan formInput = new FormInputSatuan(null, true, 1, null, this);
    ...
    private void updateData() {
        ...
        if(row != -1){
            ModelSatuan satuan = tblModel.getData(row);
            FormInputSatuan formInput = new FormInputSatuan(null, true, row, satuan, this);
            formInput.setVisible(true);
            loadData();
        }else{
