...
public class FormCustomers extends javax.swing.JPanel {

    private final TableModelCustomers tblModel = new TableModelCustomers();
    private final ServiceCustomers servis = new CustomersDAO();
    ...
    private void searchData(){
        List<ModelCustomers> list = servis.searchData(txtPencarian.getText());
        tblModel.setData(list);
    }

    private void addData() {
        FormInputCustomers formInput = new FormInputCustomers(null, true, 1, null, this);
    ...
    private void updateData() {
        ...
        if(row != -1){
            ModelCustomers cust = tblModel.getData(row);
            FormInputCustomers formInput = new FormInputCustomers(null, true, row, cust, this);
            formInput.setVisible(true);
            loadData();
        }else{
