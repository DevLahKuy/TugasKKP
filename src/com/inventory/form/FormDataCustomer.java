...
public class FormDataCustomer extends javax.swing.JDialog {
    
    private TableModelCustomers tblModel = new TableModelCustomers();
    private ServiceCustomers servis = new CustomersDAO();
    
    public ModelCustomers customer = new ModelCustomers();
    
    public FormDataCustomer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDataCustomer dialog = new FormDataCustomer(new javax.swing.JFrame(), true);
    ...
    private void selectedData() {
        ...
        customer.setNameCustomers(tblData.getModel().getValueAt(row, 1).toString());
        dispose();
    }
